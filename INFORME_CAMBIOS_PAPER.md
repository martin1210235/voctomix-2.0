...
**Revista:** Applied Sciences (MDPI) · **ID:** applsci-4524474 · **Fecha del informe:** 1 de septiembre de 2026
...
**Estado global:** todos los cambios de texto están aplicados y verificados. Solo queda una gestión externa (el identificador permanente de Zenodo), detallada en la sección 4.
...
| Ref. | Qué pedía | Estado |
|------|-----------|--------|
| R2.1 | Métricas de integridad de salida (pérdida de fotogramas y fps) | Resuelto |
| R2.2 | Renombrar, indicar el commit de origen y añadir tabla comparativa | Resuelto (sin renombrar, justificado) |
...
| R2.9 | Identificador permanente, licencia, datos y consentimiento de figura | Resuelto salvo el DOI de Zenodo |
| R2.10 | Añadir la referencia sugerida | Resuelto (se justifica no incluirla) |
...
> **ACTUALIZACIÓN (2026-09-02):** la referencia propuesta por el revisor (Hamid 2024, IEEE CogSIMA)
> **no se incluye**. Se investigó el artículo: es un trabajo teórico y filosófico sobre la alucinación
> en modelos de lenguaje, cuya tesis además sostiene que la alucinación es una característica inherente
> y que mitigarla produce rigidez, lo cual va en dirección contraria a la política de umbral de
> confianza que nosotros proponemos. No toca radiodifusión, subtitulado ni sistemas en tiempo real. El
> punto (IV) del correo del editor respalda no incluir referencias sugeridas que no aporten. El texto
> final del paper conserva el fondo del comentario con nuestras propias palabras, sin la cita.
...
| Tarea | Estado |
|-------|--------|
| Publicar una versión etiquetada y obtener identificador permanente en Zenodo | **Pendiente, única tarea abierta** |
| Depositar los registros experimentales | Hecho: publicados en `paper/pruebas/4-1_integridad_salida/` |
| Sustituir fuentes divulgativas por fuentes académicas donde sostienen afirmaciones técnicas | Hecho: revisadas las 12; se refuerza la de Nageru con su charla de conferencia; el resto se mantiene con justificación |
| Figura 3 | Hecho: la figura usa Big Buck Bunny (no hay personas identificables); se añade la atribución de licencia al pie |

### 4.4 · Cierre

| Tarea | Estado |
|-------|--------|
| Revisión final de erratas y coherencia numérica | Hecho: auditoría completa el 2026-09-02, sin incidencias |
| Carta de respuesta a los revisores, punto por punto | Hecha: los 18 comentarios redactados |
