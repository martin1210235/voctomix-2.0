...
class StudioClock(Gtk.ToolItem):
    ...
    def do_draw(self, cr):
        ...
        # setup gradients for clock background
        ...
        cr.set_source_rgb(0.764, 0.804, 0.176)
        cr.select_font_face("Roboto Condensed", cairo.FONT_SLANT_NORMAL, cairo.FONT_WEIGHT_BOLD)
        ...
        (xbearing, ybearing, textwidth, textheight, xadvance, yadvance) = cr.text_extents(text)
