...
en tiempo real del terminal durante la realización: el evento STATE y CHANGE. Toda esta información queda además registrada en un fichero .jsonl, que al finalizar la retransmisión, se guarda en un ficherocomo historial completo de la
realización.
