...
aparecen en la esquina, o viceversa. El parámetro \texttt{mirror=true} permite invertir horizontalmente la imagen de la
cámara cuando ésta llega girada especularmente.
