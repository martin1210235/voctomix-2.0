...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.54\textwidth]{figuras/señal_programa_overlays_rotulacion}
  \par\vspace{0.4cm}
  \includegraphics[width=0.54\textwidth]{figuras/panel_control_overlays_rotulacion}
