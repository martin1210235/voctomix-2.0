...
cámara. El gestor de estados de emisión (stream blanker) ofrece tres modos —LIVE,
PAUSE y NOSTREAM— que permiten interrumpir la señal de salida sin detener el
