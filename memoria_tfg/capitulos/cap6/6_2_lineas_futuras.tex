...
\begin{itemize}
  ...
  Voctomix~2.0 emplea H.264 como códec de salida predeterminado, que opera en tiempo real en CPU de gama media. La migración del
  ...
  ocho veces inferior a la de H.264. Esta mejora es directamente aplicable en los escenarios
  ...
  añadir y eliminar fuentes en caliente, modificar los parámetros de los composites
  ...
  interés consistiría en ampliar este análisis con métricas adicionales como el ancho
  de banda de red por fuente, la tasa de fotogramas entregados, la variación de
  latencia (\textit{jitter}) o el tiempo de recuperación ante fallos de un contenedor.
  Este conjunto de datos más completo permitiría caracterizar con mayor precisión el
  comportamiento del sistema en distintos entornos de despliegue y orientar futuras
