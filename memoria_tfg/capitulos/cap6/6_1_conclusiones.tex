...
de salida sin detener el procesamiento interno, y la sincronización automática del
audio con la fuente activa, que elimina la gestión manual del audio durante la
producción.
...
con Docker Compose, incluyendo voctocore, cuatro fuentes de cámara sintéticas, el \textit{stream blanker}, el gestor de audio, el \textit{broker} RabbitMQ y el servicio de telemetría. El despliegue completo se realiza con un único comando (\texttt{docker compose up}),
eliminando la instalación manual de dependencias de GStreamer y Python.
