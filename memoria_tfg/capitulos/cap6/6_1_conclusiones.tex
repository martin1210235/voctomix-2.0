...
blanker, el gestor de audio, el \textit{broker} RabbitMQ y el servicio de telemetría. El despliegue completo se realiza con un único comando (\texttt{docker compose up}),
