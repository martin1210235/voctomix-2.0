...
La necesidad de desplegar estas herramientas de producción de forma portable y
reproducible ha convertido en estándar el uso de tecnologías de contenerización
como Docker~\cite{merkel2014docker} y Kubernetes~\cite{kubernetes_burns2016},
que eliminan la instalación manual de dependencias y garantizan un comportamiento
idéntico en cualquier equipo Linux.
...
servicios distribuidos de forma fiable. Esta necesidad motivó que, en el presente trabajo, Voctomix~2.0 fuera preparado
para ejecutarse tanto en Docker Compose como en Kubernetes, objetivos que se
desarrollan en el Capítulo~\ref{chap:despliegue}.
