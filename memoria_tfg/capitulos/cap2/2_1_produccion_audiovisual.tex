...
La tabla~\ref{tab:trad_vs_remi} sintetiza los parámetros diferenciadores entre ambos
modelos. La figura~\ref{fig:cadena_produccion} ilustra los bloques funcionales de la
cadena completa: captura y contribución de señal, mezcla y procesamiento, codificación
y distribución al espectador final.
