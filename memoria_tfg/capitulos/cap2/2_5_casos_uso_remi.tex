...
mayor afluencia y múltiples salas en emisión simultánea. El equipo de producción de vídeo del
...
funcionalmente a la unidad móvil en eventos de cobertura local. La industria estima
ahorros superiores al 30\,\% respecto al modelo tradicional en implantaciones REMI de
escala comparable~\cite{tmbroadcast_remi}.
...
\begin{itemize}
  ...
  \item \textbf{NEMO (Network and Edge Media Orchestration):} proyecto europeo
        ...
        red distribuidas. Aportó experiencia previa en arquitecturas de microservicios
        que influyó en el diseño del despliegue contenerizado de Voctomix~2.0.
