...
\subsection{LaLiga (Telefónica Servicios Audiovisuales)}

Telefónica Servicios Audiovisuales fue seleccionada junto con Appear para desplegar la
nueva red de contribución y distribución de LaLiga desde Madrid, basada en
SRT~\cite{tsa_laliga_srt_2025}. Las cámaras de los estadios envían la señal mediante SRT
sobre Internet pública hasta el centro de producción remoto, donde los realizadores
operan el sistema como si estuvieran físicamente presentes en el estadio.
...
reducciones de coste relevantes en implantaciones REMI de escala comparable~\cite{tmbroadcast_remi}.
...
\begin{itemize}
  ...
  \item \textbf{NEMO (\textit{Next Generation Meta Operating System})}~\cite{nemo_cordis}: proyecto
        europeo orientado a la orquestación de servicios multimedia en infraestructuras de
  ...
  \item \textbf{CyberNEMO}~\cite{cybernemo_cordis}: proyecto europeo centrado en la ciberseguridad aplicada
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|l|l|l|X|}
    ...
    LaLiga (Telefónica)  & Red de estadios   & SRT + AES-256        & REMI sobre Internet \\
