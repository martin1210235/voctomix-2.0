...
\begin{enumerate}
  ...
  \item Contenerizar el sistema completo con Docker~Compose, de modo que
        cualquiera pueda desplegarlo sin preocuparse por
  ...
  \item Validar el sistema en distintos escenarios de despliegue, desde un único
        ordenador hasta un clúster de Kubernetes, midiendo la latencia de conmutación
        y de transición entre modos de composición, la estabilidad del \textit{pipeline} y el correcto funcionamiento del sistema
