...
consola de RabbitMQ o la \ac{API} de telemetría, aumenta el número de puntos de acceso que un atacante podría intentar explotar.
...
\begin{enumerate}
  ...
  \acs{API} de telemetría en 8080. En una red no controlada, cada puerto accesible es un vector de
...
formación y eficiencia, y no cuestionan la viabilidad del modelo REMI que habilita este proyecto.}
