...
\normalsize{El sistema se construye sobre \textit{software} libre publicado bajo licencias GPL~\cite{gpl_v2} y
...
consola de RabbitMQ o la API de telemetría, el sistema amplía su superficie de ataque (es decir, los puntos accesibles que un
atacante podría intentar explotar). Un acceso no autorizado podría interferir con
una retransmisión en directo. Por ello, quien despliega el
...
solución con \textit{hardware} dedicado de bajo consumo, algo habitual en infraestructuras de
