...
modificando progresivamente los valores de los pads del compositor de GStreamer. Las
trayectorias de interpolación se calculan mediante curvas B-Spline con las librerías
\texttt{scipy}~\cite{virtanen2020scipy} y \texttt{numpy}~\cite{harris2020numpy}.
...
El botón Retake permite al realizador deshacer el último cambio de fuente o composite y
...
intercambia programa y preview, restaurando la fuente que estaba en antena antes del
cambio.

En la práctica de la producción en directo, el flujo de trabajo más habitual consiste
en alternar entre dos fuentes o dos composites, como ocurre en una retransmisión de
