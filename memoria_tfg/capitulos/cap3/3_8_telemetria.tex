...
\subsection{Eventos Change y State}

El registro sigue una doble vía temporal:

\begin{itemize}
  \item \textbf{Evento Change (\texttt{CHANGE}):} cuando se detecta cualquier variación
  ...
  \item \textbf{Evento State (\texttt{STATE}):} un hilo paralelo escribe el estado
        completo del sistema cada 5~segundos de forma periódica, como medida de
        redundancia, independientemente de que haya habido cambios.
\end{itemize}
