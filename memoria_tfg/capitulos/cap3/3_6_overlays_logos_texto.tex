...
Con esta opción activa, cada vez que el realizador efectúa un corte de cámara el
...
La figura~\ref{fig:panel_overlays} ilustra el resultado visual y el panel de control.
