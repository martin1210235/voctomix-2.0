...
sobre la señal de vídeo: logos corporativos, overlays \ac{PNG} con canal alfa y texto
...
La posición de cada logo no la determina el pipeline de GStreamer, sino el diseño
...
\begin{figure}[H]
  ...
  \caption{Señal de programa con overlay y rotulación activos (arriba) y panel de
