...
(en directo, pausa y sin señal), sincronización automática del audio con la fuente de
...
El sistema completo se ha contenerizado mediante Docker~Compose y Kubernetes,
facilitando su despliegue reproducible en entornos de investigación universitaria,
como el del grupo CyberNEMO de la UPM, y en infraestructuras de mayor escala.
...
The complete system has been containerised using Docker~Compose and Kubernetes,
enabling reproducible deployment in university research environments such as the
UPM CyberNEMO group infrastructure, and in larger-scale deployments.
